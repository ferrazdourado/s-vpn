...
// configuration step. It creates a namespace called `s_vpn`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", s_vpn::cmake::project_name, s_vpn::cmake::project_version) };
